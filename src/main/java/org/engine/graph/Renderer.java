...
public class Renderer {
    ...
    public void render(Window window, ICamera camera, GameItem[] gameItems,
    ...
    public void renderScene(Window window, ICamera camera, GameItem[] gameItems,
            SceneLight sceneLight) {
        ...
        // Update view Matrix
        Matrix4f viewMatrix = camera.getViewMatrix();//transformation.getViewMatrix(camera);
